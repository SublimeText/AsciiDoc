...
.Optional Title
****
//^^^ meta.block.sidebar.asciidoc
//^^ punctuation.section.block.begin.asciidoc
Sidebars are used to visually separate auxiliary bits of content
that supplement the main text.
****
//^^ meta.block.sidebar.asciidoc punctuation.section.block.end.asciidoc
...
====
//^^ meta.block.example.asciidoc punctuation.section.block.end.asciidoc

=== Blockquotes
[quote,Abraham Lincoln,Address delivered at the dedication of the Cemetery at Gettysburg]
____
//^^^ meta.block.verse.asciidoc
//^^ punctuation.section.block.begin.asciidoc
Four score and seven years ago our fathers brought forth
on this continent a new nation...
____
//^^ meta.block.verse.asciidoc punctuation.section.block.end.asciidoc
...
//      ^ punctuation.definition.variable.end.asciidoc
//        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ string.unquoted.asciidoc
//                                                             ^ punctuation.separator.continuation.line.asciidoc
