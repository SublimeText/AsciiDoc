...
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ meta.paragraph.asciidoc markup.raw.block.asciidoc
...
//                 ^^^^^^^^^^ storage.modifier.role.asciidoc
...
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ meta.paragraph.asciidoc
//^^^^^^^^^^^^^^^^^^^^^ markup.underline.link.asciidoc
...
//                       ^ punctuation.section.group.parameters.begin.asciidoc
//                                        ^ punctuation.separator.sequence.asciidoc
//                                         ^^^^^^^^^^^^^ meta.attribute-with-value.asciidoc
//                                         ^^^^ meta.mapping.key.asciidoc entity.other.attribute-name.asciidoc
...
//   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ markup.underline.link.asciidoc markup.raw.inline.asciidoc
...
//^^^^^^^^^^^^^^^^^^^^^^^^^ markup.heading.4.asciidoc
//^^^ punctuation.definition.heading.begin.asciidoc
//    ^^^^^^^^^^^^^^^^^^^^^ entity.name.section.asciidoc

====== Level 5 Section Title
//^^^^^^^^^^^^^^^^^^^^^^^^^^ markup.heading.5.asciidoc
//^^^^ punctuation.definition.heading.begin.asciidoc
//     ^^^^^^^^^^^^^^^^^^^^^ entity.name.section.asciidoc
...
==============
//^^^^^^^^^^^^^ markup.heading.1.asciidoc
//^^^^^^^^^^^^ punctuation.definition.heading.setext.asciidoc
//            ^ meta.whitespace.newline.asciidoc
...
//^ markup.checkbox.begin.asciidoc punctuation.definition.checkbox.begin.asciidoc
// ^ markup.checkbox.mark.asciidoc
//  ^ markup.checkbox.end.asciidoc punctuation.definition.checkbox.end.asciidoc
* [x] also checked
//^^^^^^^^^^^^^^^^ meta.paragraph.list.asciidoc
//^ markup.checkbox.begin.asciidoc punctuation.definition.checkbox.begin.asciidoc
// ^ markup.checkbox.mark.asciidoc
...
//     ^^^ punctuation.separator.key-value.asciidoc
    . Fedora
//^^^^^^^^^^ meta.mapping.value.asciidoc meta.paragraph.list.asciidoc
...
//           ^^^^^^^ meta.mapping.key.asciidoc entity.other.attribute-name.asciidoc
//                  ^ punctuation.separator.key-value.asciidoc
//                   ^^^^^^^^^^^^ meta.mapping.value.asciidoc meta.string.asciidoc string.quoted.double.asciidoc
...
//                                ^^^^ meta.mapping.key.asciidoc entity.other.attribute-name.asciidoc
//                                    ^ punctuation.separator.key-value.asciidoc
//                                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ meta.mapping.value.asciidoc markup.underline.link.asciidoc
//                                          ^ punctuation.separator.sequence.asciidoc
//                                                                                  ^ punctuation.section.group.parameters.end.asciidoc
...
=== Literal block
....
//^^ punctuation.definition.raw.literal.begin.asciidoc
error: 1954 Forbidden search
//^^^^^^^^^^^^^^^^^^^^^^^^^^ markup.raw.code-fence.asciidoc
absolutely fatal: operation lost in the dodecahedron of doom

Would you like to try again? y/n
....
//^^ punctuation.definition.raw.code-fence.end.asciidoc

=== Listing block with title
.Gemfile.lock
//^^^^^^^^^^^ markup.bold.asciidoc
----
//^^ punctuation.definition.raw.code-fence.begin.asciidoc
GEM
//^ markup.raw.code-fence.asciidoc
...
//^^ support.type.admonition.asciidoc
//  ^ punctuation.separator.key-value.asciidoc
...
=== Admonition block
[NOTE]
//^^^^^ meta.block.admonition.asciidoc
//^^^^ punctuation.section.block.begin.asciidoc
//^^^ support.type.admonition.asciidoc
====
//^^ meta.block.admonition.asciidoc punctuation.section.block.end.asciidoc
...
.Optional Title
****
//^^ meta.block.sidebar.asciidoc punctuation.section.sidebar.begin.asciidoc
Sidebars are used to visually separate auxiliary bits of content
that supplement the main text.
****
//^^ meta.block.sidebar.asciidoc punctuation.section.sidebar.end.asciidoc

=== Example block
====
//^^ meta.block.example.asciidoc punctuation.section.example.begin.asciidoc
Here's a sample AsciiDoc document:
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ meta.block.example.asciidoc meta.paragraph.asciidoc

----
//^^ meta.block.example.asciidoc punctuation.definition.raw.code-fence.begin.asciidoc
= Title of Document
Doc Writer
:toc:

This guide provides...
//^^^^^^^^^^^^^^^^^^^^^ meta.block.example.asciidoc markup.raw.code-fence.asciidoc
----
//^^^ meta.block.example.asciidoc
//^^ punctuation.definition.raw.code-fence.end.asciidoc

The document header is useful, but not required.
====
//^^ meta.block.example.asciidoc punctuation.section.example.end.asciidoc

=== Blockquotes
[quote,Abraham Lincoln,Address delivered at the dedication of the Cemetery at Gettysburg]
____
//^^ meta.block.verse.asciidoc punctuation.section.verse.begin.asciidoc
Four score and seven years ago our fathers brought forth
on this continent a new nation...
____
//^^ meta.block.verse.asciidoc punctuation.section.verse.end.asciidoc
...
.Table Title
|===
//^^ meta.table.asciidoc punctuation.section.block.table.begin.asciidoc
|Column 1, Header Row |Column 2, Header Row
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ meta.table.asciidoc
//                    ^ punctuation.separator.table-cell.asciidoc
...
//^^^^^^^^^^^^^^^^^^^^^^^ meta.table.asciidoc meta.paragraph.asciidoc
...
|===
//^^ meta.table.asciidoc punctuation.section.block.table.end.asciidoc
...
* performance
* portability
//^^^^^^^^^^^ meta.table.asciidoc meta.paragraph.list.asciidoc
...
// <- meta.paragraph.asciidoc constant.character.escape.asciidoc
