...
//      ^^ punctuation.separator.key-value.asciidoc - markup.bold
...
--
foo
//^^ meta.block.open.asciidoc meta.paragraph.asciidoc
--
// <- meta.block.open.asciidoc punctuation.section.block.end.asciidoc
//^ - meta.block
...
+
--
// <- meta.block.open.asciidoc punctuation.section.block.begin.asciidoc
